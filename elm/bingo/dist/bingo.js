...
Elm.Bingo.make = function (_elm) {
   ...
   var link = A2($Html.a,
   _L.fromArray([$Html$Attributes.href("https://pragmaticstudios.com")]),
   ...
   model) {
      return function () {
         ...
         {case "Add":
            ...
            case "Delete":
            return function () {
                 var hasId = F2(function (id,
                 entry) {
                    return !_U.eq(entry.id,id);
                 });
                 var remainingEntries = A2($Debug.log,
                 "Remaining Entries: ",
                 A2($List.filter,
                 hasId(action._0),
                 model.entries));
            ...
            case "Sort":
            return function () {
                 var sortedEntries = A2($Debug.log,
                 "Sorted Entries: ",
                 A2($List.sortBy,
                 function (_) {
                    return _.points;
